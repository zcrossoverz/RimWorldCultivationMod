...
{
    /// <summary>
    /// Defines a cultivation ability that pawns can learn and use
    /// </summary>
    public class CultivationAbilityDef : Def
    {
        #region Basic Properties
        /// <summary>Display name for the ability</summary>
        ...
        #region Costs & Requirements
        /// <summary>Qi cost to cast</summary>
        public float qiCost = 10f;
        
        /// <summary>Cooldown in ticks</summary>
